...
public class DropboxConnectorRestClientAdapter
    extends DropboxConnectorOAuth2Adapter
    implements MuleContextAware, Disposable, Initialisable
{
    ...
    public DropboxConnectorRestClientAdapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
        super(oauthManager);
    }
        ...
        throws IOException
    {
        ...
        String uri = "https://api.dropboxapi.com/2/file_requests/get";
